...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		['VS EvanTube Creators'],
		['EvanTube',		'evan',		'Menu Artist, Composer of Tube Tussle and Gummy God',					'https://twitter.com/ItsEvanTube',	'0xFF7B28B4'],
		['Della',		'della',		'Main Artist/Programmer of VS EvanTube',					'https://twitter.com/DellaM4in',	'0xFF6E50D7'],
		['Psych Engine Team'],
