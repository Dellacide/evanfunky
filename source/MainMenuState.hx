...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['play', 'freeplay', 'credits', 'options'];
	...
	override function create()
	{
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "VS EvanTube TEST BUILD " + Application.current.meta.get('version'), 1);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
